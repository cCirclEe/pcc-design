...
\include{./subtopicsDesign/App/Architektur}
\include{./subtopicsDesign/App/Datenhaltung}
\include{./subtopicsDesign/App/Moduluebersicht}
\include{./subtopicsDesign/App/Klassenuebersicht}

% PUT WEB SERVICE CONTENT HERE


% PUT WEB INTERFACE CONTENT HERE
\include{./subtopicsDesign/WebInterface/MainWebInterface}
