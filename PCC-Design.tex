...
\include{./subtopicsDesign/Architektur}
...
\input{./subtopicsDesign/App/Architektur}
\input{./subtopicsDesign/App/Datenhaltung}
\input{./subtopicsDesign/App/Moduluebersicht}
\input{./subtopicsDesign/App/Klassenuebersicht}

% PUT WEB SERVICE CONTENT HERE
\label{chap:app}\chapter{Web-Service}

\input{./subtopicsDesign/Webservice/Architektur}
\input{./subtopicsDesign/Webservice/Datenhaltung}
\input{./subtopicsDesign/Webservice/Moduluebersicht}
\input{./subtopicsDesign/Webservice/Klassenuebersicht}


% PUT WEB INTERFACE CONTENT HERE
\label{chap:app}\chapter{Web-Interface}

\input{./subtopicsDesign/Webinterface/Architektur}
\input{./subtopicsDesign/Webinterface/Moduluebersicht}
\input{./subtopicsDesign/Webinterface/Klassenuebersicht}

%PUT ATTACHMENTS HERE
\include{./subtopicsDesign/Anhang}
