...
\textbf{Sichtbarkeit} private \newline
Schaltfläche um AccountDaten zu löschen und alle Appansichten außer die LogInActivity unzugänglich zu machen. Antippen ruft die Methode deleteAccountData() des MemoryManagers und die Methode Launch() der \nameref{app:klasse:LogInActivity} auf.
