...
Da die App und die Webanwendung auf unterschiedlichen Technologien basieren, ist es natürlich diese Komponenten getrennt zu entwickeln. Zudem entsteht eine erhöhte Flexibilität, da so z.B. erlaubt wird die App auch für andere Betriebssysteme zu entwickelt als Android, ohne die Webanwendung zu verändern. \newline
Zusätzlich wird die Webanwendung in Web-Dienst und Web-Interface unterteilt, damit um die logisch voneinander unabhängigen Komponenten App und Web-Interface zu trennen.
...
Sowohl App als auch Web-Interface besitzen eine eigenes View-Modul. Dieses ist für die grafische Benutzeroberfläche zuständig. In der App wird die View durch XML-Dokumente implementiert, die das Layout definieren. Das Web-Interface verwendet dafür die von Vaadin bereitgestellte View-Klasse, von der man eigene Klassen ableiten kann.\newline\par
...
Das Model ist dafür zuständig Daten zu verwalten und zu bearbeiten. Die App hat dafür ein eigenes Modul, das den Speicherzugriff regelt. Das Model des Web-Interfaces ist der Web-Dienst.\newline\par
