...
Der Background ist die Grundlage der graphischen Oberfläche des Webinterface. Auf dem Background werden entweder menuArea und contentArea gelegt, oder beim Login die \nameref{LoginView} Dieses Attribut wird in der init Methode erzeugt und initialisiert.
